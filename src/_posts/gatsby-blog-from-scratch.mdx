---
title: 'Gatsby Blog From Scratch: An In-depth Guide to Starting with Gatsby'
tags: ['JavaScript', 'React', 'Gatsby']
date: '2020-04-17'
description: "Building a technical GatsbyJS blog from scratch without plugins for a deeper understanding of Gatsby's core systems."
---

Are you the type of person that likes to poke around under the hood before getting started with something new? Me too!
...
The final version using our custom code is available at the [final-plugin-free](https://github.com/Daynil/quests-in-code/tree/final-plugin-free) branch in the Github repository for this blog, if you ever want to see the full picture of the code.
...
```jsx{5,8-14}:title=src/templates/blog-post.js
...
```jsx:title=src/templates/blog-post.js{6,12}
import { graphql } from 'gatsby';
import React from 'react';
...
I created this post in order to learn Gatsby more deeply as I created this very blog! So, if you're interested in seeing the full code as it stands at the end of this post, you can visit the relevant branches in the Github repository. The final version using our custom code is available at the [final-plugin-free](https://github.com/Daynil/quests-in-code/tree/final-plugin-free) branch, and the final version after we swapped everything for Gatsby plugins is available at [gatsby-plugins](https://github.com/Daynil/quests-in-code/tree/gatsby-plugins).
