...
Now we can see at a glance where we are likely to be in 2020. since chose a worst-case quantile of 0.1 and best case of 0.9, we're saying that 80% of all scenarios fall between our top and bottom quantile.
...
These types of calculations are often done using languages which have extensive libraries that enable advanced data analytics, like Python (using numpy and pandas) or R. One thing that frustrated me when I practiced data analytics using Python was the inability to extensively customize your charts and make them interactive. It felt like a whole dimension of data exploration and visualization was missing.
